...
namespace DcodePe.Catering.Persistence.Migrations
{
    ...
    [Migration("20251204165242_UpdateCategoriaPaginaatributesAdd")]
    partial class UpdateCategoriaPaginaatributesAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DcodePe.Catering.Domain.Entities.ContactanosEntity", b =>
                {
                    b.Property<int>("ContactanosID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ContactanosID"));
                    ...
                    b.ToTable("Contactanos", (string)null);
                });
            ...
            modelBuilder.Entity("DcodePe.Catering.Domain.Entities.CotizacionEntity", b =>
                {
                    ...
                    b.Property<decimal>("CostoDePersonal")
                    ...
                    b.Property<TimeOnly?>("HoraContacto")
                        .HasColumnType("time");
                    ...
                    b.Property<decimal>("PrecioPorCubierto")
                        .HasColumnType("decimal(10, 2)");

                    b.Property<decimal>("PrecioPorCubiertoConDescuento")
                        .HasColumnType("decimal(10, 2)");

                    b.Property<decimal>("SubtotalMenu")
                        .HasColumnType("decimal(10, 2)");

                    b.Property<decimal>("TarifaMenuPorInvitado")
                        .HasColumnType("decimal(10, 2)");
            ...
            modelBuilder.Entity("DcodePe.Catering.Domain.Entities.CategoriaEntity", b =>
                {
                    b.HasOne("DcodePe.Catering.Domain.Entities.CategoriaEntity", "CategoriaPadre")
            ...
            modelBuilder.Entity("DcodePe.Catering.Domain.Entities.CotizacionEntity", b =>
                {
                    ...
                    b.HasOne("DcodePe.Catering.Domain.Entities.EventoEntity", "Evento")
                        .WithMany("Cotizaciones")
