    ...
    public class CreateCotizacionValidator : AbstractValidator<CreateCotizacionModel>
    {
        ...
        public CreateCotizacionValidator(IDataBaseService databaseService)
        {
            ...
            RuleFor(x => x)
                ...
                .WithMessage("Una o m�s fechas seleccionadas ya est�n reservadas para este local (evento confirmado).")
                .When(x => x.EstadoCotizacion != "Borrador");
            ...
            RuleFor(x => x.NumeroInvitados)
                .GreaterThanOrEqualTo(0).WithMessage("El número de invitados no puede ser negativo")
                .When(x => x.EstadoCotizacion == "Borrador");
            ...
            RuleFor(x => x.EstadoCotizacion)
                ...
                .WithMessage("El estado de la cotización debe ser: Activo, Anulado, Evento, Pendiente o Borrador");
